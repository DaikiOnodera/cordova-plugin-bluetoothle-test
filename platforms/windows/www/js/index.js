...
function startScan() {
    ...
    if (window.cordova.platformId === "windowss") {
...
function addService(address, serviceUuid, characteristics){
    ...
    characteristics.forEach(function(characteristic){
        ...
        characteristicValueSpan.id = serviceuuid.toUpperCase() + "." + characteristic.uuid.toUpperCase();
        ...
        readSequence = readSequence.then(function(){
            if(characteristic.uuid==uuids["rxCharacteristic"].toUpperCase()){
                ...
                }).then(()=>{console.log("test");}, handleError);
            }
            else{
                return new Promise(function(resolve, reject){
                    resolve();
...
function reportValue(serviceUuid, characteristicUuid, value) {
    document.getElementById(serviceUuid + "." + characteristicUuid).style.color = "red";
